// Shared service page defaults for API routes and website pages
// This ensures mobile app and website always get the same merged content
...
export const SERVICE_PAGE_DEFAULTS: Record<string, any> = {
  ...
  'restaurant-construction': {
    ...
    services: {
      title: '服務項目',
      description: '我們提供完整的餐廳工程服務，從設計到施工，確保每個環節都達到專業標準',
      items: [
        {
          title: '餐廳設計規劃',
    ...
    contact: {
      title: '立即諮詢',
      description: '專業團隊為您提供免費諮詢與報價服務，讓我們為您的餐廳工程提供最佳解決方案',
      button1Text: '聯絡我們',
      button2Text: '免費報價',
    },
  },
