...
export default function PurchaseSaleAgreementPage() {
  ...
  const [tempTitle, setTempTitle] = useState(PURCHASE_SALE_DEFAULT_TITLE);
  const [tempContent, setTempContent] = useState(PURCHASE_SALE_DEFAULT_CONTENT);
  ...
  const saveChanges = async () => {
    try {
      setSaving(true);
      const pageRef = doc(db, 'pages', 'purchase-sale-agreement');
      await setDoc(pageRef, {
        title: tempTitle,
        slug: 'purchase-sale-agreement',
        content: tempContent,
