...
const PrivacyPolicyScreen: React.FC = () => {
  ...
  const [title, setTitle] = useState('隱私政策');
  ...
  useEffect(() => {
    ...
    const load = async () => {
      try {
        ...
        const response = await fetch(`${baseEndpoint}/api/pages/privacy`, {
          method: 'GET',
          headers: {
        ...
        <View style={styles.contentSection}>
          {sections.length === 0 ? (
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>尚未設定隱私政策內容</Text>
            </View>
          ) : (
            <>
